...
export default function AppointmentPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!project_description.trim()) return setError("Please describe your project.");
    ...
    if (!contact_number.trim()) return setError("Please enter a contact number.");
  ...
  const handleCancel = async (id) => {
    ...
    try {
      ...
      alert(err.response?.data?.message || "Could not cancel appointment request.");
    }
  };
            ...
            {submitted ? (
              ...
              <>
                <div className="appt-card-header">
                  ...
                  <p>
                    Online requests are for Consultation and Site Measurement only.
                    Installation schedules are arranged by staff after order confirmation.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="appt-form">
                  ...
                  <div className="appt-field">
                    ...
                    <textarea
                      ...
                      maxLength={500}
                    />
                    <div className="appt-char-count">{project_description.length}/500</div>
                  </div>
                  ...
                  <div className="appt-field">
                    <label className="appt-label">
                      Additional Notes <span className="appt-optional">(optional)</span>
                    </label>
                    <textarea
                      className="appt-textarea"
                  ...
                  return (
                    <div key={a.id} className="appt-item">
                      ...
                      <div className="appt-item-meta">
                        <span>
                          <Calendar size={12} /> {formatDateTime(a.scheduled_date)}
                        </span>
                      </div>
