        ...
        : blueprints.length === 0
          ...
          : <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(260px, 1fr))', gap:16 }}>
              {blueprints.map(bp => (
                ...
                >
                  {bp.thumbnail_url
                    ? <img src={bp.thumbnail_url} alt={bp.title} style={{ width:'100%', height:120, objectFit:'cover', borderRadius:8, marginBottom:12 }} />
      ...
      {selected && (
        <div style={{
          ...
          <div style={{ background:'white', borderRadius:16, width:'100%', maxWidth:680, maxHeight:'85vh', overflowY:'auto', padding:32 }}>
            ...
            {selected.thumbnail_url && <img src={selected.thumbnail_url} alt="" style={{ width:'100%', borderRadius:10, marginBottom:20 }} />}
