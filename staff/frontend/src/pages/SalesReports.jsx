...
export default function SalesReports() {
  ...
  // Set default dates on load (Today and 30 Days Ago)
  ...
  // Setup Axios interceptor to attach the token
  ...
  const fetchReport = async () => {
    ...
    try {
      ...
      const res = await axiosInstance.get(`/api/pos/reports?${params}`);
      setData(res.data);
    } catch (err) {
          ...
          <div className="stat-grid" style={{ marginBottom: 20 }}>
            ...
            <div className="stat-card">
              ...
              <div>
                <div className="stat-value">
                  ₱
                  {parseFloat(data.totals.grand_total || 0).toLocaleString(
                    "en-PH",
            ...
            <div className="stat-card">
              ...
              <div>
                <div className="stat-value">
                  ₱
                  {parseFloat(data.totals.total_discount || 0).toLocaleString(
                    "en-PH",
                    { minimumFractionDigits: 2 },
                  )}
                </div>
                ...
                <tbody>
                  {data.top_products.map((p, i) => (
                    <tr key={i}>
                      ...
                      <td>
                        ₱
                        {parseFloat(p.revenue).toLocaleString("en-PH", {
                          minimumFractionDigits: 2,
                        })}
                      </td>
                    </tr>
                  ...
                  <tbody>
                    {data.summary.map((s, i) => (
                      <tr key={i}>
                        ...
                        <td>
                          ₱
                          {parseFloat(s.total_sales).toLocaleString("en-PH", {
                            minimumFractionDigits: 2,
                          })}
                        </td>
                      </tr>
