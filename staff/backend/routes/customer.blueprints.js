 ...
 *
 * GET /api/customer/blueprints      — gallery list
 * GET /api/customer/blueprints/:id  — single blueprint + components
 */
...
/* GET /api/customer/blueprints/:id */
