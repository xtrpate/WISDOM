      ...
      <div className="auth-root">
        <div className="auth-split">
          <div className="auth-brand-panel">
            ...
            <p>
              Your email has been verified. Your account is now waiting for
              admin review. We'll notify you by email once approved.
            </p>
          </div>
          <div className="auth-card-panel" style={{ justifyContent: "center" }}>
            <div className="pending-screen">
              ...
              <div className="pending-steps">
                ...
                {[
                  "Our admin team will review your account within 1–2 business days.",
                  "You'll receive an email notification once your account is approved.",
                  "After approval, you can log in and start browsing our products.",
                ].map((s, i) => (
          ...
          <form className="auth-form" onSubmit={handleRegister}>
            ...
            <div className="terms-check">
              ...
              <label htmlFor="terms">
                ...
                . I understand my account requires admin approval before I can
                log in.
              </label>
            </div>
