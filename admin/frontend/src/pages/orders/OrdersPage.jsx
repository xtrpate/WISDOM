      ...
      <div style={headerBlock}>
        <div>
          ...
          <p style={pageSubtitle}>
            Keep the list focused on review, payment checks, and the next order
            step.
          </p>
        </div>
        ...
        <div style={tableHeader}>
          <div>
            ...
            <p style={tableSubtitle}>
              Use the detail page for approvals, payment review, contract, and
              delivery actions.
            </p>
          </div>
        </div>
                  ...
                  return (
                    <tr key={order.id} style={tbodyRow}>
                      ...
                      <td style={td}>
                        <button
                          onClick={() => navigate(`/orders/${order.id}`)}
                          style={isPending ? btnPrimary : btnView}
                        >
