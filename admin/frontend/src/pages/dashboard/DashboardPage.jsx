...
export default function DashboardPage() {
  ...
  const pendingOrders = Number(orders.pending_orders || 0);
  const processingOrders = Number(orders.processing_orders || 0);
  const shippedOrders = Number(orders.shipped_orders || 0);
  const cancelledOrders = Number(orders.cancelled_orders || 0);
    ...
    <div className="dash-shell">
      ...
      <section className="metric-grid">
        ...
        <MetricCard
          ...
          meta={`${num.format(completedOrders)} completed · ${num.format(
            pendingOrders,
          )} pending`}
        />
        <MetricCard
          ...
          meta={`${num.format(Number(inventory.low_stock_count || 0))} low stock · ${num.format(
        ...
        <MetricCard
          ...
          meta={`${num.format(totalChannelOrders)} non-cancelled orders`}
        />
      </section>
      ...
      <section className="dashboard-grid dashboard-grid--main">
        <div className="dash-card">
          <div className="card-header">
            <div>
              <div className="section-kicker">Sales Analytics</div>
              <h3 className="card-title">Sales Trend</h3>
              <p className="card-description">
                Revenue movement across the selected date range.
              </p>
            </div>
          </div>
        ...
        <div className="dash-card">
          <div className="card-header">
            <div>
              ...
              <p className="card-description">
                Fulfillment status overview for current orders.
              </p>
            </div>
          </div>
        ...
        <div className="dash-card">
          <div className="card-header">
            <div>
              ...
              <p className="card-description">
                Key stock indicators for products and raw materials.
              </p>
            </div>
          </div>
          ...
          <div className="inventory-panel">
            <div className="inventory-panel__grid">
              ...
              <MiniStat
                label="Low Stock"
                value={num.format(Number(inventory.low_stock_count || 0))}
                tone="amber"
              />
              <MiniStat
                label="Out of Stock"
                value={num.format(Number(inventory.out_of_stock_count || 0))}
                tone="red"
              />
              <MiniStat
                label="Raw Low Stock"
                value={num.format(Number(inventory.raw_low_stock || 0))}
                tone="violet"
              />
            </div>

            <div className="inventory-note">
              <div className="inventory-note__title">Attention Needed</div>
              <div className="inventory-note__text">
                {Number(inventory.out_of_stock_count || 0) > 0 ||
                Number(inventory.raw_out_of_stock || 0) > 0
                  ? `${num.format(
                      Number(inventory.out_of_stock_count || 0),
        ...
        <div className="dash-card">
          <div className="card-header">
            <div>
              ...
              <p className="card-description">
                Best-selling items ranked by units sold.
              </p>
            </div>
          </div>
