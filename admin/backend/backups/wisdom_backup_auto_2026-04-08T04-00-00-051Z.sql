...
-- Generated: 2026-04-08T04:00:00.051Z
...
(1, 'auto', NULL, 'wisdom_backup_auto_2026-04-07T16-00-00-848Z.sql', 43, 'D:\\downloadss\\CAP1\\Wisdom\\wisdomcode2\\admin\\backend\\backups\\wisdom_backup_auto_2026-04-07T16-00-00-848Z.sql', 'success', NULL, '2026-04-07 16:00:00');
...
CREATE TABLE `cart_items` (
  ...
  `wood_type` varchar(100) DEFAULT NULL,
  `item_type` varchar(50) DEFAULT 'ready_made',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_cart_item` (`customer_id`,`item_key`),
  CONSTRAINT `cart_items_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `cart_items` (`id`, `customer_id`, `item_key`, `product_id`, `product_name`, `image_url`, `unit_price`, `quantity`, `wood_type`, `item_type`, `created_at`) VALUES
(1, 10, '1', 1, 'Classic Wall Cabinet', NULL, 5500, 1, NULL, 'ready_made', '2026-04-08 03:32:01');
...
(4, 5, NULL, '2026-04-09 16:13:00', NULL, 'PDM', 'in_transit', NULL, '1233', '2026-04-07 16:14:05');
...
(5, 'SWS-GCASH-DEMO-0005', 8, NULL, NULL, 'online', 'standard', 'shipping', 'gcash', 'unpaid', 5500, 0, 0, 5500, NULL, 0, 0, '/uploads/payments/gcash-demo-proof-0005.jpg', 'Lias, Marilao, Bulacan', 'Fresh online GCash demo order for manual flow testing.', NULL, NULL, NULL, 0, 'none', '2026-04-06 15:41:53', '2026-04-07 16:14:05'),
...
(1, 'SWS-CAB-001', 'Classic Wall Cabinet', 'Fresh retest seed product after database cleanup', 1, 'standard', NULL, 0, 5500, 5000, 3200, 1800, 9, 2, 'in_stock', '2026-04-06 14:45:15', '2026-04-06 15:44:23');
...
(1, 'System Administrator', 'admin@spiralwood.com', NULL, '$2y$12$4O4lGdDJN61BQdKkUZ9BceRupEJLxmHWKtkj3CRdK9zeYbCw5ky/.', 'admin', NULL, NULL, NULL, NULL, 1, NULL, NULL, 'approved', NULL, '2026-04-05 05:48:11', 1, '2026-04-07 15:55:23', '2026-04-05 05:48:11', '2026-04-07 15:55:23', NULL, NULL),
(2, 'Adrian Dela Cruz', 'adrian.delacruz@spiralwood.com', NULL, '$2y$12$oYLIeSU5D75WMmswNg23qekJgVgbmCLAHWEedO4nGakIuWMBXMoXq', 'staff', NULL, NULL, NULL, NULL, 1, NULL, NULL, 'approved', 1, '2026-04-05 05:48:11', 1, NULL, '2026-04-05 05:48:11', '2026-04-05 05:48:11', NULL, NULL),
...
(7, 'Sophia Martinez', 'sophia.martinez@gmail.com', NULL, '$2y$12$hgZYMn1kKk4OGSaA3/2kBuMbeCqaUHUxZjKqmo8x4GM6lBomUgyYu', 'customer', '09171234611', NULL, 'Prenza 1, Marilao, Bulacan', NULL, 1, NULL, NULL, 'approved', 1, '2026-04-05 05:48:11', 1, NULL, '2026-04-05 05:48:11', '2026-04-05 05:48:11', NULL, NULL),
(8, 'Daniel Reyes', 'daniel.reyes@gmail.com', NULL, '$2y$12$hgZYMn1kKk4OGSaA3/2kBuMbeCqaUHUxZjKqmo8x4GM6lBomUgyYu', 'customer', '09171234612', NULL, 'Lias, Marilao, Bulacan', NULL, 1, NULL, NULL, 'approved', 1, '2026-04-05 05:48:11', 1, NULL, '2026-04-05 05:48:11', '2026-04-05 05:48:11', NULL, NULL),
...
(10, 'john marc', 'baluktottite7@gmail.com', NULL, '$2a$12$eiZWPJitCvQHb9g7u0Br7.MFBWdUNK8nu9vuZGhw/CW3M7PvLi0lC', 'customer', '09123456789', NULL, 'PDM', NULL, 1, NULL, NULL, 'approved', NULL, NULL, 1, '2026-04-08 03:31:58', '2026-04-07 15:53:59', '2026-04-08 03:31:58', NULL, NULL),
(11, 'staff', 'staff@spiralwood.com', NULL, '$2a$12$0AlOzIy7AK2SX8V7mfEjCuzQYRv11ereloxj43pGfgoZQKuaQwD2i', 'staff', '09123456789', NULL, NULL, NULL, 1, NULL, NULL, 'approved', NULL, NULL, 1, '2026-04-07 16:06:31', '2026-04-07 15:55:55', '2026-04-07 16:06:31', NULL, NULL);
